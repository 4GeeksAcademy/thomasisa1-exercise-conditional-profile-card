...
function render(variables = {}) {
  ...
  <li><a href="https://twitter.com/${
    variables.twitter == null ? "4geeksacademmy" : variables.twitter
  }"><i class="fab fa-twitter"></i></a> </li>
  <li><a href="https://github.com/${
    variables.github == null ? "4geeksacademmy" : variables.github
  }"><i class="fab fa-github"></i></a> </li>
  <li><a href="https://linkedin.com/${
    variables.linkedin == null ? "4geeksacademmy" : variables.linkedin
  }"><i class="fab fa-linkedin"></i></a> </li>
  <li><a href="https://instagram.com/${
    variables.instagram == null ? "4geeksacademmy" : variables.instagram
